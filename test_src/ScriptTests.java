...
public class ScriptTests {
    ...
    public ScriptTests() {
        ...
        kit = new WalletAppKit(networkParameters, new File(wallet_name), "!1.42060485724!");
    }
    ...
    private void testTransaction(ScriptTransaction scriptTransaction) throws InsufficientMoneyException {
        ...
        Transaction transaction = scriptTransaction.createOutgoingTransaction(inputScript,Coin.parseCoin("0.0008"));
    ...
    public void testPayToPubKeyHash() throws InsufficientMoneyException {
        try (ScriptTransaction payToPubKeyHash = new PayToPubKeyHash(networkParameters, new File(wallet_name), "!1.42060485724!")) {
